        ...
        <form method="post" action="controller/controllerUsuario.php">
            ...
            <div class="corpo margin">
                ...
                <div class="div_normal">
                    ...
                    <input class="input" name="tipo" type="text" placeholder=" Digite o seu tipo: " value="<?= isset($_POST['tipo']) ? $_POST['tipo'] : '' ?>" />
                </div>

                <div class="div_normal">
                    <label class="label"> Escolha o livro </label>
                    <input class="input" name="livro" type="text" placeholder=" Digite o livro que deseja levar " value="<?= isset($_POST['livro']) ? $_POST['livro'] : '' ?>" />
                </div>
