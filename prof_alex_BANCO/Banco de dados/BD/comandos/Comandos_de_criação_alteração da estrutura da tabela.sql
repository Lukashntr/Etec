***********************************************************
--Comando para conex�o com Banco de Dados
***********************************************************

-----------------------------------------------------------

--Comando para conectar
mysql -u root -p (-u = usu�rio do banco de dados, -p = senha do banco de dados)

-----------------------------------------------------------

***********************************************************
--Comando para a cria��o das estruturas em Banco de Dados
***********************************************************
...
***********************************************************
--Comando para cria��o de tabela
***********************************************************

-----------------------------------------------------------
--Comando de cria��o da tabela de exemplo pessoa
CREATE TABLE pessoa (
...
DESCRIBE pessoa;
***********************************************************
--Comando para a altera��o das estruturas em Banco de Dados
***********************************************************

-----------------------------------------------------------

--Comando para a altera��o do nome da tabela.
...
--comando para a inclus�o da primary key na tabela pessoa
...
--Comando para a inclus�o de foreign key
...
--comando para a altera��o do nome e tipo de dado da coluna(para a mudan�a de tipo de dado precisa alterar o nome com change)
alter table pessoa change idade idadenova int
-----------------------------------------------------------

--comando para a altera��o de todas as caracteisticas das colunas
